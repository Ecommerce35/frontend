...
const OrderDetail = () => {
  ...
  const fetchOrderDetails = async () => {
    try {
      const response = await api.get(`/api/v1/auth/user/order/${id}/`);
    ...
    <Button 
      ...
      {loading ? (
        ...
        <>
          ...
          <Typography variant="body1" gutterBottom>
            Total: GHS{orderDetails.total.toFixed(2)}
          </Typography>
          <Typography variant="body1" gutterBottom>
          ...
          <Typography mb={4} variant="body1" gutterBottom>
            Date: {orderDetails.overall_delivery_message}
          </Typography>
              ...
              <TableBody>
                {orderDetails.order_products.map((product, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>{product.delivery_range}</TableCell>
